...
/**
 * BQTransactionCaptureRetrieveOutputModelTransactionCaptureInstanceRecord
 */
public class BQTransactionCaptureRetrieveOutputModelTransactionCaptureInstanceRecord   {
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to the card transaction as recorded by issuer and/or acquirer 
